              ...
              <ul className="pl-2 space-y-2">
                <li>
                  <a
                    ...
                    className="focus:outline-none hover:p-2 hover:px-4 hover:border hover:rounded-lg hover:border-none hover:bg-gray-500 hover:text-white transition-all duration-200 inline-block hover:my-1"
                  >
